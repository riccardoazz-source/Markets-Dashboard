...
export const MODEL_VERSIONS: ModelVersion[] = [
  ...
  },
  {
    ...
    formula: [
      ...
      'DrawdownQuality (the falling-winner sleeve, weight 0.30): a QUALITY name (Ret12m > 0, R2_12m) sitting',
      '   AT/BELOW its 200D MA (−35%..+5%) with volume quietly building (VolRatio ≥ 1.1) AND positive money',
      '   flow (up-vol − down-vol over 20d > 0) → QuietAccum = baseProximity·min(1,(VolRatio−1)·MoneyFlow/0.25)·R².',
      '   Ray\'s "buyers accumulating before the crowd" — 0 unless every condition aligns (never a falling knife).',
