...
export const MODEL_VERSIONS: ModelVersion[] = [
  ...
  },
  {
    ...
    formula: [
      ...
      '',
      'Rationale: M1 gave REG=1.0 to ALL above-MA200 assets (same signal).',
      'Graduated REG distinguishes a structural bull leader (price +30% above MA200)',
      'from a fresh breakout barely above it — capturing "how far in the trend" not',
      'just "yes/no above". Expected to improve pick quality in 1M / 6M periods.',
      '',
      'Gate: r1m>0 ∧ r3m>0 ∧ aRecent>0 ∧ r1m<cap ∧ price ≥ MA200',
      '   cap = 50%   ·   commodities 25%',
    ],
